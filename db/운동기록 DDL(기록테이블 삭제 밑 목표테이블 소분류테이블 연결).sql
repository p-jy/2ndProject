...
ALTER TABLE `SHARE_RECORD` ADD CONSTRAINT `FK_MAJOR_CATE_TO_SHARE_RECORD_1` FOREIGN KEY (
	`SR_MC_NUM`
)
...
ALTER TABLE `GOAL` ADD CONSTRAINT `FK_SUB_CATE_TO_GOAL_1` FOREIGN KEY (
	`SC_NUM`
)
REFERENCES `SUB_CATE` (
	`SC_NUM`
